...
public class RoundButton : Control
{
    ...
    private Color _onHoverBorderColor = Color.FromArgb(50,50,50);
    private Color _buttonColor = Color.FromArgb(43, 43, 43);
    private Color _onHoverButtonColor = Color.FromArgb(50,50,50);
    ...
    protected override void OnPaint(PaintEventArgs e)
    {
        ...
        g.FillEllipse(brush, 0, Height-12, 12, 12);
        g.FillEllipse(brush, Width - 12, 0, 12, 12);
        g.FillEllipse(brush, Width - 12, Height - 12, 12, 12);
        g.FillRectangle(brush, 0, 6, Width, Height-12);
        g.FillRectangle(brush, 6, 0, Width-12, Height);
